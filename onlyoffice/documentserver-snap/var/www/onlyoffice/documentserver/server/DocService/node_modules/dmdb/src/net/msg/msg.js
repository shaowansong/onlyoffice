...
var __extends = this && this.__extends || function() {
    ...
    return function(t, s) {
        ...
        n(t, s), t.prototype = null === s ? Object.create(s) : (i.prototype = s.prototype, 
        new i());
    };
}();
...
var buffer_1 = require("../buffer"), error_1 = require("../../driver/error"), const_1 = require("../../desc/const"), events_1 = require("events"), timer_1 = require("../../utils/timer"), Msg = function(_) {
    function M(t, s, i, n) {
        var r = _.call(this) || this;
        return r.vs = t, r.mt = new buffer_1.DmBuffer(M.Rs), r.Qt = s, r.fs = 0, r.ir = i, 
        r._callback = n, r._timeout = t.at.conn_prop_socketTimeout, r._timer = new timer_1.Timer(function() {
            r.emit("timeout");
        }), r;
    }
    return __extends(M, _), M.prototype.Tt = function() {
        this.emit("packet", this.mt.Xt);
        ...
        try {
            ...
            i = t, this.emit("error", t);
        } finally {
            try {
                this._callback && this._callback.apply(this, [ i, s ]);
            } finally {
                this.emit("end");
            }
        }
    }, M.prototype.At = function() {
        this.Xs(), this.te(), this.Ks();
    }, M.prototype.Xs = function() {
        this.mt.pt(0), this.mt.$t(M.lt, !0, !0);
    }, M.prototype.Ks = function() {
        this.mt.v(M.Js, this.ir ? this.ir.handle : 0), this.mt.y(M.Qs, this.Qt), this.mt.v(M.in, this.mt.St - M.lt);
